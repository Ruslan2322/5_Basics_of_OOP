package Lesson_05.Ex_05.action;

import Lesson_05.Ex_05.builder.CandyPresentBuilder;
import Lesson_05.Ex_05.builder.PresentDirector;
import Lesson_05.Ex_05.entity.*;
...
public class Client {
    ...
    private static List<Product> readCandyFile() {
        ...
        String filePath = "src/main/resources/candies.txt";
        try {
